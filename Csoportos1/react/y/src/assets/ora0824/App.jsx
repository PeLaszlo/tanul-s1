...
import ListMessages2 from "./listMessage2.jsx"
...
function App()
{
    ...
    return (
        <>
            <Card card={card} />
            <LongText shortText={"ez a rövid változat"} longText={"Ez a hosszú szöveg helyetti szöveg."}/>
            <LongText2 text={"ez a megadott teszt szöveg amit rövidítünk"} number={"5"}/>
            <RemovableList list={list}/>
            <MyForm />
            < ValidateRegistration />
            <ImageCatalog imglist={imglist} />
            <ListMessages messageList={mList} />
            <hr></hr>
            <ListMessages2 />
        </>
    )
